...
INSERT INTO order_items (order_id, product_id, quantity, price_in_cent) VALUES ($1, $2, $3, $4) RETURNING id, order_id, product_id, quantity, price_in_cent, created_at
`
...
UPDATE products SET quantity = $1 WHERE id = $2 RETURNING id, name, price_in_cent, quantity, created_at
`
